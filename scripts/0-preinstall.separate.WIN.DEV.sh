...
sgdisk -n 3::+150G --typecode=3:8300 --change-name=3:'ROOT' ${DISK} # partition 3 (Root), default start, 150GB
sgdisk -n 4::+8G --typecode=4:8200 --change-name=4:'SWAP' ${DISK} # partition 4 (Swap), default start, 8GB
sgdisk -n 5::+120G --typecode=5:0700 --change-name=5:'WINDOWS' ${DISK} # partition 5 (WINDOWS), default start, 120GB
sgdisk -n 6::-0 --typecode=6:8300 --change-name=6:'DEV' ${DISK} # partition 6 (DEV), default start, remaining
