...
sgdisk -n 3::+200G --typecode=3:8300 --change-name=3:'ROOT' ${DISK} # partition 3 (Root), default start, 150GB
sgdisk -n 4::+8G --typecode=4:8200 --change-name=4:'SWAP' ${DISK} # partition 4 (Swap), default start, 8GB
sgdisk -n 5::-0 --typecode=5:8300 --change-name=5:'DEV' ${DISK} # partition 5 (DEV), default start, remaining
